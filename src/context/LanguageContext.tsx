  ...
  experience: {
    ...
    timeline: [
      ...
      },
      {
        ...
        detail: 'Advisor: Yin Yang  ·  FlameGS: photo-realistic facial reconstruction via Gaussian Splatting + FLAME model',
        tag: 'RESEARCH',
      },
      {
        period: '2025',
        institution: 'Tencent IEG — Lightspeed Studio',
        role: 'Technical Intern — AI Agent Development',
        detail: 'Interactive Entertainment Group · Lightspeed Studio · AI Agent pipeline development for game production workflows',
        tag: 'INDUSTRY',
      },
      {
        period: '2025 — 2027',
